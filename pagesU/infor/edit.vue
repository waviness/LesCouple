<template>
	<view class="eidt-user-info pb-100">
		<view class="edit-user-info-form bg-white">
			<u-form :model="model1" :rules="rules" ref="form1" labelWidth="90">
				<u-form-item prop="userInfo.attr" label="属性" borderBottom required @click="showType = true">
					<u-input v-model="model1.userInfo.attr" disabled placeholder="请选择" disabledColor="transparent"
				...
				<u-form-item prop="userInfo.city" label="城市" borderBottom required @click="showCity = true">
					<u-input v-model="model1.userInfo.city" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.birth" label="出生" borderBottom required @click="showDate = true">
					<u-input v-model="model1.userInfo.birth" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				<u-datetime-picker :show="showDate" @cancel="showDate = false" @confirm="confirmBirth" v-model="value1"
					:minDate="-2209017943000" :maxDate="Number(new Date())" mode="date"></u-datetime-picker>
				<u-form-item prop="userInfo.job" label="职业" borderBottom @click="showJob = true">
					<u-input v-model="model1.userInfo.job" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.education" label="学历" borderBottom @click="showEducation = true">
					<u-input v-model="model1.userInfo.education" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.height" label="身高" borderBottom @click="showHeight = true">
					<u-input v-model="model1.userInfo.height" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.state" label="感情状态" borderBottom @click="showState = true">
					<u-input v-model="model1.userInfo.state" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.hair" label="发长" borderBottom @click="showHair = true">
					<u-input v-model="model1.userInfo.hair" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.pet" label="宠物" borderBottom @click="showPet = true">
					<u-input v-model="model1.userInfo.pet" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.house" label="房产" borderBottom @click="showHouse = true">
					<u-input v-model="model1.userInfo.house" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.income" label="收入" borderBottom @click="showIncome = true">
					<u-input v-model="model1.userInfo.income" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.constellation" label="星座" borderBottom @click="showConstellation = true">
					<u-input v-model="model1.userInfo.constellation" disabled placeholder="请选择"
						disabledColor="transparent" border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				...
				<u-form-item prop="userInfo.situation" label="出柜情况" borderBottom @click="showSituation = true">
					<u-input v-model="model1.userInfo.situation" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
				<u-picker :show="showSituation" @cancel="showSituation = false" :columns="situationColumns"
					@confirm="confirmSituation"></u-picker>
				<u-form-item prop="userInfo.child" label="育儿计划" borderBottom @click="showChild = true">
					<u-input v-model="model1.userInfo.child" disabled placeholder="请选择" disabledColor="transparent"
						border="none" color="#333"></u-input>
					<u-icon slot="right" name="arrow-right"></u-icon>
				</u-form-item>
	...
	export default {
		...
		methods: {
			...
			confirmEducation(e) {
				...
				this.model1.userInfo.education = e.value[0].label
			},
			// 学历确认
			confirmHeight(e) {
