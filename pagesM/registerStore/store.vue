 ...
 * @LastEditTime: 2022-11-12 20:52:29
...
<template>
	<view class="register-store">
		<u-form labelPosition="left" :model="model" :rules="rules" ref="registerStoreForm">
			...
			<u-form-item label="店铺LOGO" prop="storeInfo.store_log" class="store-item store-logo" labelWidth="80px"
				...
				<view class="store-log">
					<u-upload :fileList="fileListstore_logo" @afterRead="afterRead" @delete="deletePic" name="store_logo"
			...
			<u-form-item label="店铺广告" prop="storeInfo.store_ad" class="store-item store-ad" labelWidth="80px"
				...
				<u-upload :fileList="fileListstore_ad" @afterRead="afterRead" @delete="deletePic" name="store_ad" multiple
					:previewFullImage="true" :maxCount="5" width="200rpx" height="200rpx"></u-upload>
				<view class="store-tips">最多上传5张图片，只支持.jpg格式</view>
			</u-form-item>
			<u-form-item label="店铺描述" prop="storeInfo.store_desc" labelWidth="160rpx" borderBottom ref="item4">
				<u-textarea placeholder="请输入描述信息,500字以内,请勿填写电话号码/微信等联系方式" v-model="model.storeInfo.store_desc" count maxlength="500">
				</u-textarea>
			</u-form-item>
		...
		<u-button type="primary" text="申请注册" customStyle="margin-top: 100rpx" @click="submit"></u-button>
	</view>
</template>
...
export default {
	data() {
		return {
			...
			fileListstore_logo: [],
			fileListstore_ad: []
			// fileListstore_ad: [{ url: 'https://cdn.uviewui.com/uview/swiper/1.jpg' }],
		}
	},
	onReady() {
